...
const InfoTooltip = ({ isOpen, isError, onClose, errorMessage }) => {
  const errorText = errorMessage || 'Что-то пошло не так! Попробуйте ещё раз.';
  ...
  return (
    <div className={`popup ${isOpen ? 'popup_opened' : ''}`}>
      ...
      >
        {isError ? errorText : successMessage}
